...
export default function HomePage() {
  ...
  const features = [
    {
      ...
      description: "We come to you - home, office, or anywhere in Auckland",
    },
    {
      icon: Clock,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      {/* Hero Section with Full-Width Image on Right */}
      <section className="relative pt-32 pb-20 px-4 md:px-12 w-full overflow-hidden">
        <div className="flex flex-col md:flex-row items-center w-full min-h-[400px]">
          ...
          {/* Right: Full-Height, Full-Width Image */}
          <div className="w-full md:w-1/2 h-64 md:h-[500px] relative flex-shrink-0">
            <img
              src="/images/ourstory.jpg"
              alt="Fone Fixer Hero"
              className="absolute inset-0 w-full h-full object-cover rounded-md object-center md:object-right z-0"
            />
            ...
            {services.map((service, index) => (
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <CardContent className="p-8">
                  <div className="w-full h-48 rounded-lg overflow-hidden mb-6 group-hover:scale-105 transition-transform">
                    <img
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              At Fonefixer, we offer the most affordable phone repair solutions without compromising on quality. Whether
              it's a cracked screen, battery replacement, or software issue, our skilled technicians provide top-notch
              repairs at unbeatable prices.
            </p>
          </div>
